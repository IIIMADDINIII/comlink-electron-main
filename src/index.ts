...
export function wrap<T>(ep: MessagePortMain, target?: any): Remote<T> {
...
export function transfer<T>(obj: T, transfers: MessagePortMain[]): T {
...
function toWireValue(value: any): [WireValue, MessagePortMain[]] {
